...
<body>
    ...
    <div class="container py-5">
        <div class="row">
            <div class="col-12">
                <h1 class="fw-bold text-info">Articles</h1>
                <hr class="w-50">
        ...
        <div class="row mb-4 pb-4 border-bottom bg-light p-2">
            <div class="col-12 col-md-4">
                <a href="<?= base_url('articles/' . $id) ?>">
                    <img src="<?= esc($item['image']) ?>" class="img-fluid rounded" alt="Article Image">
                </a>
            </div>
            <div class="col-12 col-md-8">
                <h5 class="fw-bold">
                    <a href="<?= base_url('articles/' . $id) ?>" class="text-decoration-none text-dark">
                        <?= esc($item['title']) ?>
                    </a>
                </h5>
