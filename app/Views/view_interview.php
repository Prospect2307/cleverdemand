...
<head>
    ...
    <title><?= esc($interviewItem['title']) ?></title>
...
<body>
    ...
    <nav class="container mt-3" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><?= esc($interviewItem['title']) ?></li>
        </ol>
    </nav>
    ...
    <div class="container py-4">
        <div class="row d-flex bgColor justify-content-between p-3">
            ...
            <div class="col-md-6 text-end">
                <img src="<?= esc($interviewItem['image']) ?>" class="img-fluid rounded" alt="Article Image" />
            </div>
        </div>
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-3">
                <div class="text-start mb-3">
                    <span class="featured-label fw-bold">In this interview</span>
                </div>
                ...
                <div class="nav flex-column nav-pills" id="articleTabs" role="tablist" aria-orientation="vertical">
                    ...
                    $contentOriginal = $interviewItem['content'] ?? 'Content not available.';
