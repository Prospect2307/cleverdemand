...
',
    ...
    {
        $data['interviews'] = $this->interviews;
        return view('interviews', $data);
    }

    public function view($id)
    {
        if (!array_key_exists($id, $this->interviews)) {
            throw \CodeIgniter\Exceptions\PageNotFoundException::forPageNotFound();
        }

        $article = $this->interviews[$id];
        ...
        $data['interviewItem'] = $article;
        return view('view_interview', $data);
    }
}
